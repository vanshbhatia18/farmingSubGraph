...
export const events = {
    ...
    IncreaseLiquidity: new LogEvent<([tokenId: bigint, liquidity: bigint, actualLiquidity: bigint, amount0: bigint, amount1: bigint, pool: string] & {tokenId: bigint, liquidity: bigint, actualLiquidity: bigint, amount0: bigint, amount1: bigint, pool: string})>(
...
export const functions = {
    ...
    algebraMintCallback: new Func<[amount0Owed: bigint, amount1Owed: bigint, data: string], {amount0Owed: bigint, amount1Owed: bigint, data: string}, []>(
        abi, '0x3dd657c5'
    ),
    ...
    createAndInitializePoolIfNecessary: new Func<[token0: string, token1: string, sqrtPriceX96: bigint], {token0: string, token1: string, sqrtPriceX96: bigint}, string>(
        abi, '0x51246d6e'
    ),
